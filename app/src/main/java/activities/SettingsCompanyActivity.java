...
public class SettingsCompanyActivity extends AppCompatActivity {
            ...
            try {
                ...
                if (bitmap != null) {
                    ...
                    uploadTask.addOnFailureListener(e -> {
                        Toast.makeText(SettingsCompanyActivity.this, "Error on upload image", Toast.LENGTH_SHORT).show();
                    })
                    .addOnSuccessListener(taskSnapshot -> {
                        Toast.makeText(SettingsCompanyActivity.this, "Photo Successfully uploaded", Toast.LENGTH_SHORT).show();
    ...
    private void updateUserPhoto(Uri url) {
        ...
        if (result) {
            ...
            Toast.makeText(SettingsCompanyActivity.this, "The photo was updated", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void updateUsername() {
        ...
        if (result) {
            ...
            loggedUser.update();
            Toast.makeText(SettingsCompanyActivity.this, "Name Successfully updated", Toast.LENGTH_SHORT).show();
        }
    }*/
}